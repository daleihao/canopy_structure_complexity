...
%% import data
% POLDER
LAI_mean = importdata('trend_data/LAI_mean2.csv', ',');
%LAI_std = importdata('trend_data/LAI_std.csv', ',');
EVI_mean = importdata('trend_data/EVI_mean2.csv', ',');
...
text(2003, 5.4, ['Slope=' num2str(slope_value, '%.4f')], 'color', 'b', 'fontsize', 14)
text(2003, 5.2, ['P-value=' num2str(p_value, '%.4f')], 'color','b', 'fontsize', 14)

%text()
box on
axis([2003-0.5 2020.5 5 7])
ylabel('LAI')
xlabel('Year')
...
text(2003, 0.64, ['Slope=' num2str(slope_value, '%.4f')], 'color', 'b', 'fontsize', 14)
text(2003, 0.62, ['P-value=' num2str(p_value, '%.4f')], 'color','b', 'fontsize', 14)
%plot([0 0], [0 1], '--k', 'Linewidth', 1)


axis([2003-0.5 2020.5 0.6 0.8])
box on
xlabel('Year')
ylabel('EVI')
set(gca, 'Linewidth', 1.5, ...
