...
plot_figure1 <- plot_grid(plot_SIF + theme(legend.position="none"),
...
ggsave("figure_S3b.tiff", plot = plot_figure1, width = 30, height = 7, units = "cm", dpi = 600, limitsize = FALSE, compression = "lzw")