...
%% import data
% POLDER
EVICrop_P = importdata('POLDER-MISR/POLDER/Combine_NIRV_CROP_Observation.txt');
EVIEBF_P = importdata('POLDER-MISR/POLDER/Combine_NIRV_EBF_Observation.txt');
EVISIM_P = importdata('POLDER-MISR/POLDER/Combine_NIRV_Simu.txt');
...
%MISR
EVICrop_M = importdata('POLDER-MISR/MISR/Combine_NIRV_CROP_Observation.txt');
EVIEBF_M = importdata('POLDER-MISR/MISR/Combine_NIRV_EBF_Observation.txt');
EVISIM_M = importdata('POLDER-MISR/MISR/Combine_NIRV_Simu.txt');
...
%% save plots
print(gcf, '-dtiff', '-r600', ['figure_MISR_POLDER_NIRV' '.tif'])
close all