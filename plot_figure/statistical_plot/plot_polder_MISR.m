...
%% import data
% POLDER
EVICrop_P = importdata('POLDER-MISR/POLDER/Combine_EVI_CROP_Observation.txt');
EVIEBF_P = importdata('POLDER-MISR/POLDER/Combine_EVI_EBF_Observation.txt');
EVISIM_P = importdata('POLDER-MISR/POLDER/Combine_EVI_Simu.txt');
...
%MISR
EVICrop_M = importdata('POLDER-MISR/MISR/Combine_EVI_CROP_Observation.txt');
EVIEBF_M = importdata('POLDER-MISR/MISR/Combine_EVI_EBF_Observation.txt');
EVISIM_M = importdata('POLDER-MISR/MISR/Combine_EVI_Simu.txt');
...
%% save plots
print(gcf, '-dtiff', '-r600', ['figure_MISR_POLDER_EVI' '.tif'])
close all