...
%% import data
% POLDER
EVICrop_P = importdata('POLDER-MISR/POLDER/Combine_NDVI_CROP_Observation.txt');
EVIEBF_P = importdata('POLDER-MISR/POLDER/Combine_NDVI_EBF_Observation.txt');
EVISIM_P = importdata('POLDER-MISR/POLDER/Combine_NDVI_Simu.txt');
...
%MISR
EVICrop_M = importdata('POLDER-MISR/MISR/Combine_NDVI_CROP_Observation.txt');
EVIEBF_M = importdata('POLDER-MISR/MISR/Combine_NDVI_EBF_Observation.txt');
EVISIM_M = importdata('POLDER-MISR/MISR/Combine_NDVI_Simu.txt');
...
%% save plots
print(gcf, '-dtiff', '-r600', ['figure_MISR_POLDER_NDVI' '.tif'])
close all